 ...
 <div align="center"> 
   <img src="https://img.shields.io/static/v1?label=dedicate days&message=4&color=success">
...
the best way to learn is by testing, you can compile the examples with g++ -std=c++17 without any problems.
